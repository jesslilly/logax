...
set -x
./node_modules/jasmine-node/bin/jasmine-node --captureExceptions $@ test/logaxnmSpec.js
...
./node_modules/jasmine-node/bin/jasmine-node --captureExceptions $@ test/oncelernmSpec.js